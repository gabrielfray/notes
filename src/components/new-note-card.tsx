...
export const NewNoteCard = ({ onNoteCreated }: INewNoteCardProps) => {
  ...
  return (
    <Dialog.Root>
      <Dialog.Trigger className='rounded-md flex flex-col bg-slate-700 text-left p-5 gap-3 outline-none hover:ring-2 hover:ring-slate-600 cursor-pointer focus-visible:ring-2 focus-visible:ring-lime-400' >
